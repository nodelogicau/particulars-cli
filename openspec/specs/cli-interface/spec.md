...
The agent-facing contract of the `particulars` binary: non-interactive operation, `--json` output on every verb, stable exit codes, workspace selection, and provenance defaults from the environment.
