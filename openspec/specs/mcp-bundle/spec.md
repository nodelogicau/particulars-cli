...
The Claude Desktop extension bundle (`.mcpb`): its manifest and contents, the user configuration form, platform handling, release attachment, and the documented client configurations.
