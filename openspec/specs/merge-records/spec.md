...
The `mrg_` merge record type: the `particular merge` verb, the equivalence classes that merged particulars form for query verbs, retraction of merges, and merge validation.
